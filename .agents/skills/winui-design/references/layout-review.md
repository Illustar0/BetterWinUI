...
Load this when reviewing responsive behaviour, breakpoints, or state coverage on a data-driven page. SKILL.md already
covers theming, control choice, and XAML landmines — don't duplicate.
...
Breakpoints are **app-window effective pixels**, not physical screen pixels. The window can be `<640` epx on a 4K
monitor.
