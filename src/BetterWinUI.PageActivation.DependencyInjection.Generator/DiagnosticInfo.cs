...
internal enum DiagnosticKind : byte
{
    ...
    /// <summary>Identifies the InvalidView diagnostic.</summary>
    InvalidView,
    /// <summary>Identifies the InvalidViewModel diagnostic.</summary>
    InvalidViewModel,
    /// <summary>Identifies the IncompatibleModule diagnostic.</summary>
    IncompatibleModule,
    /// <summary>Identifies the MissingPublicConstructor diagnostic.</summary>
    MissingPublicConstructor,
    /// <summary>Identifies the MissingPagePublicConstructor diagnostic.</summary>
    MissingPagePublicConstructor,
    /// <summary>Identifies the UnsupportedLifetime diagnostic.</summary>
    UnsupportedLifetime,
}
